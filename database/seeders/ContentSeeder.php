    ...
    public function run(): void
    {
        ...
        $themen = [
            [
                ...
                'inhalt' => '<p>Neue Autorität nach Haim Omer bietet Eltern und Fachpersonen einen klaren Rahmen für den Umgang mit herausforderndem Verhalten. Im Zentrum stehen Präsenz, Deeskalation und die Stärkung unterstützender Netzwerke.</p><h3>Kernprinzipien</h3><ul><li>Wachsame Sorge statt Kontrolle</li><li>Gewaltfreier Widerstand</li><li>Ankerfunktion und Beharrlichkeit</li><li>Netzwerk und Transparenz</li></ul>',
            ...
            [
                ...
                'inhalt' => '<p>Systemische Beratung betrachtet Probleme nicht isoliert, sondern im Kontext von Beziehungen und Strukturen. Der Fokus liegt auf Ressourcen und Lösungen statt auf Defiziten.</p>',
            ...
            [
                ...
                'inhalt' => '<p>Konflikte gehören zum Alltag. Deeskalation bedeutet nicht, Konflikte zu vermeiden, sondern sie so zu gestalten, dass Beziehungen intakt bleiben und alle Beteiligten ihre Würde behalten.</p>',
                'zielgruppen' => json_encode(['eltern', 'fachpersonen', 'institutionen']),
                'aktiv' => true,
            ],
            [
                ...
                'inhalt' => '<p>Gelungene Kommunikation ist die Basis jeder guten Beziehung. Hier erfahren Sie, wie Sie auch in emotionalen Momenten den Draht zu Ihrem Kind behalten.</p>',
            ...
            [
                ...
                'inhalt' => '<p>Der Bündner Standard definiert klare Qualitätsstandards für den Schutz von Kindern und Jugendlichen in stationären Einrichtungen. Er umfasst Prävention, Intervention und Nachsorge.</p>',
            ...
            [
                ...
                'inhalt' => '<p>Pädagogische Fachpersonen tragen eine hohe emotionale Last. Burnout-Prävention beginnt mit Selbstwahrnehmung und reicht bis zu strukturellen Veränderungen im Arbeitsumfeld.</p>',
